    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
      ...
      <li class="nav-group">
        ...
        <ul class="nav-group-items compact">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/components/calendar/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Calendar
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
                  class="ci-primary" />
                <path fill="var(--ci-primary-color, currentcolor)"
                  d="M304 16v32h137.373L188.687 300.687l22.626 22.626L464 70.627V208h32V16z" class="ci-primary" />
              </svg>
              <span class="badge badge-sm bg-danger ms-auto">PRO</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="components/cards.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Cards
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="components/chip.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Chip
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/components/loading-buttons/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Loading Buttons
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="components/navs-tabs.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Navs &amp; Tabs
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="components/placeholders.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Placeholders
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="components/spinners.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Spinners
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="components/tables.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Tables
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="components/toasts.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Toasts
            </a>
          </li>
      ...
      <li class="nav-group">
        ...
        <ul class="nav-group-items compact">
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/autocomplete/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Autocomplete
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="forms/chip-input.html">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Chip input
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/date-picker/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Date Picker
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/date-range-picker/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Date Range Picker
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/multi-select/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Multi Select
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/otp-input/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              OTP Input
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/password-input/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Password Input
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/range-slider/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Range Slider
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/rating/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Rating
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/stepper/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Stepper
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/time-picker/" target="_blank">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              Time Picker
              <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="var(--ci-primary-color, currentcolor)" d="M400 464H48V104h192V72H16v424h416V272h-32z"
      ...
      <li class="nav-group">
        ...
        <ul class="nav-group-items compact">
          <li class="nav-item">
            <a class="nav-link" href="error-pages/404.html" target="_top">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              404
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="error-pages/500.html" target="_top">
              <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
              500
            </a>
          </li>
        ...
        <a class="nav-link" href="https://coreui.io/bootstrap/docs/templates/installation/" target="_blank">
          <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="var(--ci-primary-color, currentcolor)"
              ...
              class="ci-primary" />
            <path fill="var(--ci-primary-color, currentcolor)" d="M136 296h224v32H136zm0 80h224v32H136z"
              class="ci-primary" />
          </svg>
          Docs
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link text-primary fw-semibold" href="https://coreui.io/product/bootstrap-dashboard-template/"
          target="_top">
          <svg class="nav-icon text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="var(--ci-primary-color, currentcolor)"
              d="m487.938 162.108-224-128a16 16 0 0 0-15.876 0l-224 128a16 16 0 0 0 .382 28l224 120a16 16 0 0 0 15.112 0l224-120a16 16 0 0 0 .382-28M256 277.849 65.039 175.548 256 66.428l190.961 109.12Z"
              class="ci-primary" />
            <path fill="var(--ci-primary-color, currentcolor)"
              d="M263.711 394.02 480 275.061v-36.522L256 361.74 32 238.539v36.522L248.289 394.02a16 16 0 0 0 15.422 0"
              class="ci-primary" />
            <path fill="var(--ci-primary-color, currentcolor)"
              ...
              <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                <div>
                  <div class="fs-4 fw-semibold">
                    ...
                    <span class="fs-6 fw-normal">
                      ...
                      <svg class="icon me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="var(--ci-primary-color, currentcolor)"
                          d="m367.997 338.75-95.998 95.997V17.503h-32v417.242l-95.996-95.995-22.627 22.627L256 496l134.624-134.623z"
                          class="ci-primary" />
                      </svg>
                      )
                    </span>
                ...
                <div class="dropdown">
                  <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown"
                    ...
                    <svg class="icon me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                      <path fill="var(--ci-primary-color, currentcolor)"
                        d="M256 144a64 64 0 1 0-64-64 64.07 64.07 0 0 0 64 64m0-96a32 32 0 1 1-32 32 32.036 32.036 0 0 1 32-32m0 320a64 64 0 1 0 64 64 64.07 64.07 0 0 0-64-64m0 96a32 32 0 1 1 32-32 32.036 32.036 0 0 1-32 32m0-272a64 64 0 1 0 64 64 64.07 64.07 0 0 0-64-64m0 96a32 32 0 1 1 32-32 32.036 32.036 0 0 1-32 32"
                        class="ci-primary" />
                    </svg>
                  </button>
                ...
                <div>
                  <div class="fs-4 fw-semibold">
                    ...
                    <span class="fs-6 fw-normal">
                      ...
                      <svg class="icon me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="var(--ci-primary-color, currentcolor)"
                          d="M390.624 150.625 256 16 121.376 150.625l22.628 22.627 95.997-95.998v417.982h32V77.257l95.995 95.995z"
                          class="ci-primary" />
                      </svg>
                      )
                    </span>
              ...
              <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                ...
                <button class="btn btn-primary" type="button">
                  <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="var(--ci-primary-color, currentcolor)"
                      d="M272 434.744V209.176h-32v225.568l-51.882-51.882-22.628 22.627L256 496l90.51-90.511-22.628-22.627z"
                      class="ci-primary" />
                    <path fill="var(--ci-primary-color, currentcolor)"
                      d="M400 161.176c0-79.4-64.6-144-144-144s-144 64.6-144 144a96 96 0 0 0 0 192h80v-32h-80a64 64 0 0 1 0-128h32v-32a112 112 0 0 1 224 0v32h32a64 64 0 0 1 0 128h-80v32h80a96 96 0 0 0 0-192"
                      class="ci-primary" />
                  </svg>
                </button>
              </div>
