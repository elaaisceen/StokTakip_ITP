            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">Yeni Kategori Ekle</li>
               ...
               <!--begin::Quick Example-->
                <div class="card card-primary card-outline mb-4">
                  ...
                  if($_POST){
                    ...
                    $kaydet=$code->kaydetKategoriyi($entity);
                    if ($kaydet){
                      ?>
                      <div class="alert alert-success">Kategori başarılı bir şekilde kaydedilmiştir. Lütfen bekleyiniz, yönlendiriliyorsunuz...</div>
                    <?php 
                          go("../login.php?do=kategoriler",3);
                        } else { ?>
                        <div class="alert alert-danger">Hata ! Kategori kaydedilemedi. Lütfen tekrar deneyiniz.</div>
                        <?php } ?>
